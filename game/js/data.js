...
export const EXTERMINATUS = {
  ...
  radius: 130,
  dmg: 5200,
  volleys: 7,          // залп идёт очередью, а не одной вспышкой
  ecoPenalty: 0.15,    // доход планеты после такого — шестая часть
  desc: 'Весь флот бьёт по указанному квадрату. Уничтожает всё живое ' +
        'в радиусе — и твои войска тоже. Планета после этого приносит ' +
        'шестую часть дохода до конца кампании.',
};
