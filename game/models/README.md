...
### Дырявые модели — это нормально

Скачанная или сгенерированная модель почти никогда не бывает
герметичной: после упрощения сетки в корпусе остаются открытые края,
а у части полигонов нормали смотрят внутрь. Игра рисует такие модели
**с двух сторон**, поэтому дыр, сквозь которые виден космос, не будет.
Ничего чинить в модели не надо.

Заодно игра приглушает отражения приезжей модели: генераторы любят
отдавать «металл с нулевой шероховатостью», и на полной интенсивности
корпус превращается в каплю хрома, отражающую весь фон.
